...
public class Tester {
    ...
    public void maxTest() {
        ...
        assertEquals(14, max_class.max(new int[] { 0, -5, 2, 14, 10 }));
    ...
    public void threeSumTest() {
        ...
        assertTrue(threeSum_Class.threeSum(new int[] { -6, 3, 10, 200 }));
        // REPLACE THIS WITH MORE TESTS.
    }
    ...
    public void threeSumDistinctTest() {
        ...
        assertFalse(threeSumDistinct_Class.threeSumDistinct(new int[] { -6, 3, 10, 200 }));
        // REPLACE THIS WITH MORE TESTS.
    }
