...
public abstract class PermutationTest {
    ...
    public void testInvertChar() {
        Permutation p = getNewPermutation("(BACD) (Z)", getNewAlphabet("ABCDEZ"));
    ...
    public void testSize() {
        ...
        Permutation q = getNewPermutation("(BACD)", getNewAlphabet("ABCDEFGH"));
        Permutation r = getNewPermutation("(BACD) (YLZ) (F)", getNewAlphabet());
    ...
    public void testPermuteInt() {
        Permutation p = getNewPermutation("(BACD) (E)", getNewAlphabet("ABCDEZ"));
