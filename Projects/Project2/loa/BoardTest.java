...
public class BoardTest {
    ...
    static final String BOARDINITSTRING =
            "===\n"
                    + "    - b b b b b b - \n"
                    + "    w - - - - - - w \n"
                    + "    w - - - - - - w \n"
    ...
    public void toStringTest() {
        String resultOfToString = new Board(BOARD1, BP).toString();
        resultOfToString = resultOfToString.replaceAll("\\r\\n", "\n");
    ...
    public void testEquals2() {
        String b1 = new Board(BOARDINIT, BP).toString();
